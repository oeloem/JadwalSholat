package com.example.oeloem.jadwalsholat;
...
import com.example.oeloem.jadwalsholat.api.ApiService;
import com.example.oeloem.jadwalsholat.api.ApiUrl;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView tv_lokasi_value, tv_fajr_value, tv_shurooq_value, tv_dhuhr_value, tv_asr_value, tv_maghrib_value, tv_isya_value;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_refresh.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) { getJadwal();}
        });
    }
    ...
    private void getJadwal() {
        ...
        call.enqueue(new Callback<ModelJadwal>() {
            ...
            public void onFailure(Call<ModelJadwal> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(MainActivity.this, "Sorry, pleaase try again... server down..", Toast.LENGTH_SHORT).show();
